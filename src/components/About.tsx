    ...
    <section id="about" className="py-20 bg-white dark:bg-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-8 transition-colors duration-300">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Research Philosophy</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Innovation-centered, pursuing breakthrough research achievements</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Collaborative Excellence</h4>
                  <p className="text-gray-600 dark:text-gray-300">Promoting interdisciplinary collaboration for mutual development</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">Social Responsibility</h4>
                  <p className="text-gray-600 dark:text-gray-300">Committed to solving social problems and serving human development</p>
                </div>
              </div>
            </div>
          </div>
